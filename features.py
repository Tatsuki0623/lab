...
dir_path = 'python-code/lab/out_data/results/DNN/'
...
for dir_name in dir_names:
    ...
    target_file_path = 'python-code/lab/out_data/results/DNN/' + dir_name + '/shap_20_mean_high_explanation.csv'
...
print(state_df)
state_df.to_csv('python-code/lab/out_data/results/DNN/AllFeatures.csv')
