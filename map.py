...
material_name = 'NOX_OX_NMHC_TEMP'

df = pd.read_csv(f'python-code/lab/out_data/coordinate/csv/{material_name}_coordinate.csv', index_col = None, header = 0)
...
folium_map.save(f'python-code/lab/out_data/coordinate/html/coordinate_{material_name}.html')