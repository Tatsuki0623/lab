...
for dir_name in dir_names:
    ...
    for path in target_shaps:
        ...
        if len(split_file_name) == 3:
            save_file_name = split_file_name[0] + '_30_' + split_file_name[1] + '_' + split_file_name[2]
            ...
            save_file_name = split_file_name[0] + '_30_' + split_file_name[1] + '_' + split_file_name[2] + '_' + split_file_name[3]
        ...
        pd.DataFrame(df.abs().mean()).sort_values(by = 0, ascending = False).head(30).to_csv(target_dir_path + save_file_name)